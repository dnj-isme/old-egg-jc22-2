...
export default function CustomerRow(props: StoreRowParams) {
  ...
  return (
    <tr>
      ...
      <td className={style['table-2']}><Comp.P>{props.data.first_name} {props.data.last_name}</Comp.P></td>
      <td className={style['table-3']}><Comp.P>{props.data.email}</Comp.P></td>
      <td className={style['table-4']}><Comp.P>{props.data.phone}</Comp.P></td>
      <td className={style['table-5']}><Comp.P>{props.data.subscribe.toString()}</Comp.P></td>
      <td className={style['table-6']}><Comp.P>{props.data.status}</Comp.P></td>
      <td>
        {
